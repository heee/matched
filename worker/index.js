...
const LAYOUT_POSITIONS = {
  ...
  "open-book": () => [...rect(0, 2, 0, 3, 0), ...rect(4, 6, 0, 3, 0), ...rect(1, 1, 1, 2, 1), ...rect(5, 5, 1, 2, 1)],
  "sun-court": () => [...rect(0, 6, 0, 4, 0).filter((p) => (p.x >= 2 && p.x <= 4) || (p.y >= 1 && p.y <= 3)), ...rect(2, 4, 2, 2, 1)],
  "eight-winds": () => [...rect(0, 7, 0, 4, 0), ...rect(1, 6, 1, 3, 1).filter((_, i) => i % 3 !== 2)],
  "twin-pillars": () => [...rect(0, 7, 0, 2, 0), ...rect(2, 5, 0, 1, 1)],
  "lantern-row": () => [...rect(0, 7, 0, 2, 0), ...rect(1, 2, 0, 2, 1), ...rect(5, 6, 0, 2, 1)],
  "stone-stair": () => [...rect(0, 7, 0, 3, 0).filter((p) => p.x >= p.y && p.x <= p.y + 4), ...rect(0, 7, 0, 3, 1).filter((p) => p.x >= p.y + 1 && p.x <= p.y + 3)],
  "garden-gate": () => [...rect(0, 7, 0, 4, 0), ...rect(1, 6, 0, 3, 1), ...rect(3, 4, 1, 2, 2)],
  "river-bend": () => [...rect(0, 8, 0, 3, 0), ...rect(3, 6, 1, 2, 1)],
  "rain-window": () => [...rect(0, 7, 0, 4, 0).filter((p) => p.x === 0 || p.x === 7 || p.y === 0 || p.y === 4), ...rect(1, 6, 1, 3, 1).filter((p) => p.x === 1 || p.x === 6 || p.y === 1 || p.y === 3)],
  "crescent-bay": () => [...rect(0, 8, 0, 4, 0).filter((p) => p.x <= 2 || p.y === 0 || p.y === 4), ...rect(0, 1, 1, 3, 1), ...rect(6, 8, 2, 2, 1)],
  "twin-peaks": () => [...rect(0, 7, 0, 4, 0), ...rect(1, 6, 1, 3, 1), { x: 3, y: 2, z: 2 }, { x: 4, y: 2, z: 2 }],
  "hollow-square": () => [...rect(0, 7, 0, 4, 0), ...rect(1, 6, 2, 2, 1)],
  "pagoda-steps": () => [...rect(0, 7, 0, 3, 0), ...rect(1, 6, 0, 2, 1), ...rect(2, 5, 1, 2, 2), ...rect(3, 4, 1, 1, 3)],
  "bamboo-grove": () => [...rect(0, 7, 0, 4, 0).filter((p) => p.x <= 1 || (p.x >= 3 && p.x <= 4) || p.x >= 6), ...rect(0, 7, 1, 2, 1).filter((p) => p.x <= 1 || (p.x >= 3 && p.x <= 4) || p.x >= 6)],
  "nine-gates": () => [...rect(0, 7, 0, 4, 0), ...rect(1, 6, 0, 3, 1), ...rect(2, 5, 1, 2, 2)],
  "diamond-court": () => [...rect(0, 7, 0, 3, 0), ...rect(1, 6, 0, 3, 1), ...rect(3, 4, 1, 2, 2)],
  "crown-keep": () => [...rect(0, 7, 0, 3, 0), ...rect(0, 1, 0, 3, 1), ...rect(6, 7, 0, 3, 1), ...rect(3, 4, 1, 2, 1)],
  "arrowhead": () => [...rect(0, 8, 0, 4, 0).filter((p) => Math.abs(p.x - 4) + Math.abs(p.y - 2) <= 4), ...rect(1, 7, 1, 3, 1).filter((p) => Math.abs(p.x - 4) + Math.abs(p.y - 2) <= 2)],
  "cross-gate": () => [...rect(0, 6, 0, 3, 0), ...rect(2, 4, 0, 3, 1)],
  "terraced-steps": () => [...rect(0, 7, 0, 3, 0), ...rect(1, 6, 0, 3, 1), ...rect(2, 5, 0, 3, 2), ...rect(3, 4, 0, 3, 3)],
  "lotus-fan": () => [...rect(0, 8, 0, 4, 0).filter((p) => Math.abs(p.x - 4) <= p.y), ...rect(0, 8, 2, 4, 1).filter((p) => Math.abs(p.x - 4) <= p.y - 1)],
  "porcelain-arch": () => [...rect(0, 8, 0, 4, 0).filter((p) => p.y === 0 || p.x <= 1 || p.x >= 7), ...rect(1, 7, 0, 0, 1)],
  "long-table": () => [...rect(0, 9, 0, 3, 0), ...rect(2, 7, 0, 2, 1)],
  "four-corners": () => [...rect(0, 7, 0, 4, 0), ...rect(0, 1, 0, 1, 1), ...rect(6, 7, 3, 4, 1)],
  "cedar-terrace": () => [...rect(0, 9, 0, 3, 0), ...rect(1, 8, 0, 2, 1), ...rect(2, 7, 1, 2, 2)],
  "compass-rose": () => [...rect(0, 8, 0, 4, 0).filter((p) => p.y === 2 || (p.x >= 3 && p.x <= 5) || ((p.x <= 1 || p.x >= 7) && (p.y <= 1 || p.y >= 3))), ...rect(2, 6, 1, 3, 1).filter((p) => p.y === 2 || p.x === 4)],
  ...
  "jade-pavilion": () => [...rect(0, 8, 0, 4, 0), ...rect(1, 7, 1, 3, 1)],
  "scholars-garden": () => [...rect(0, 8, 0, 4, 0).filter((p) => p.x === 0 || p.x === 8 || p.y === 0 || p.y === 4 || (p.x >= 3 && p.x <= 5 && p.y >= 1 && p.y <= 3)), ...rect(1, 7, 1, 3, 1).filter((p) => p.x === 1 || p.x === 7 || p.y === 1 || p.y === 3), ...rect(3, 5, 2, 2, 1)],
  ...
  "azure-temple": () => [...rect(0, 8, 0, 3, 0), ...rect(1, 7, 0, 3, 1), ...rect(2, 6, 1, 2, 2), ...rect(3, 5, 1, 2, 3)],
  "enamel-wings": () => [...rect(0, 3, 0, 4, 0), ...rect(5, 8, 0, 4, 0), ...rect(1, 3, 1, 3, 1), ...rect(5, 7, 1, 3, 1), ...rect(3, 5, 2, 2, 2), { x: 4, y: 1, z: 2 }],
  "jade-labyrinth": () => [...rect(0, 8, 0, 3, 0), ...rect(1, 7, 0, 3, 1), ...rect(2, 6, 1, 2, 2), ...rect(3, 4, 1, 2, 3)],
  "moon-palace": () => [...rect(0, 9, 0, 4, 0), ...rect(1, 8, 0, 3, 1), ...rect(2, 7, 1, 2, 2), ...rect(4, 5, 1, 2, 3)],
  "black-pagoda": () => [...rect(0, 8, 0, 4, 0), ...rect(1, 7, 0, 4, 1), ...rect(2, 6, 1, 3, 2), ...rect(3, 5, 1, 2, 3), { x: 4, y: 2, z: 4 }],
  "great-wall": () => [...rect(0, 11, 0, 7, 0), ...rect(1, 8, 1, 4, 1), ...rect(3, 7, 2, 3, 2), ...rect(4, 5, 2, 3, 3), { x: 4, y: 2, z: 4 }, { x: 5, y: 2, z: 4 }],
};
